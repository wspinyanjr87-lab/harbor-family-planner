...
This is Harbor-Family-Planner's working product plan for Harbor Family Planner Lite V1.
...
3. Copy or rebuild only public-safe family planner code into Harbor-Family-Planner.
...
8. Package for sale.
9. Connect deployment only to `Harbor-Family-Planner` when ready.
